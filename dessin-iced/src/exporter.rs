		...
		self.frame.fill_text(iced_widget::canvas::Text {
			...
			font: iced_core::Font {
				...
				weight: match text.weight {
					...
					FontWeight::EXTRA_BOLD => iced_core::font::Weight::ExtraBold,
					FontWeight::BLACK => iced_core::font::Weight::Black,
					_ => iced_core::font::Weight::Normal,
				},
				stretch: Default::default(),
				style: match text.style {
					FontStyle::Normal => iced_core::font::Style::Normal,
					FontStyle::Italic => iced_core::font::Style::Italic,
