...
//!
//! assert_eq!(svg, r#"<svg width="50px" height="50px" viewBox="-25 -25 50 50"><text x="10" y="10" text-anchor="left" font-size="16" font-weight="bold" fill='#FF0000' >Hello, world!</text></svg>"#);
//! ```
