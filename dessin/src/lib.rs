...
//! 
//! impl MyComponent {
//! 	pub fn value(&mut self, value: u32) -> &mut Self { /* skip impl */ }
//! 	pub fn into_value<T: Into<u32>>(&mut self, value: T) -> &mut Self { /* skip impl */ }
//! 	pub fn my_bool(&mut self) -> &mut Self { /* skip impl */ }
//! }
//! ```
